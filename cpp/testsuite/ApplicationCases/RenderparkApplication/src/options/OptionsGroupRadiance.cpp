...
#include "vsdk/toolkit/galerkin/GalerkinRadianceMethod.h"
    ...
    #include "options/OptionsGroupRayMatter.h"
    #include "options/OptionsGroupBidirectionalRaytracing.h"
    #include "options/OptionsGroupPhotonMap.h"
    #include "options/OptionsGroupRandomWalkRadiosity.h"
    #include "options/OptionsGroupStochasticRaytracing.h"
    #include "options/OptionsGroupStochasticRelaxationRadiosity.h"
    ...
    #include "vsdk/toolkit/raycasting/stochasticRaytracing/StochasticJacobiRadianceMethod.h"

...
double
BasisTriGalerkin::tg6(double u, double v) {
...
double
BasisTriGalerkin::tg7(double u, double v) {
...
double
BasisTriGalerkin::tg8(double u, double v) {
...
double
BasisTriGalerkin::tg9(double u, double v) {
...
BasisTriGalerkin::instance() {
    static GalerkinBasis triBasis = {
        ...
        GalerkinBasis::MAX_BASIS_SIZE, // Size
        {
            ...
            BasisTriGalerkin::tg2,
            BasisTriGalerkin::tg3,
            BasisTriGalerkin::tg4,
            BasisTriGalerkin::tg5,
            BasisTriGalerkin::tg6,
            BasisTriGalerkin::tg7,
            BasisTriGalerkin::tg8,
            BasisTriGalerkin::tg9
        }, // Functions

...
#include "vsdk/toolkit/numericalAnalysis/QuadCubatureRule.h"
#include "vsdk/toolkit/numericalAnalysis/TriangleCubatureRule.h"
    ...
    if ( isCluster() ) {
        ...
        switch ( galerkinState->basisType ) {
            ...
            case GalerkinBasisType::GALERKIN_CUBIC:
                ...
                break;
            default:
                Logger::fatal(-1, "galerkinElementReAllocCoefficients", "Invalid basis type %d", galerkinState->basisType);
        }
    }

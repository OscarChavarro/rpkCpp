...
#include "vsdk/toolkit/skin/BoundingBoxCoordinateIndex.h"
...
inline bool
AxisAlignedBoundingBox::clipAxisSlab(
    float minimumBound,
    float maximumBound,
    float origin,
    float direction,
...
inline bool
AxisAlignedBoundingBox::intersectingSegment(const Ray *ray, float *tMin, float *tMax) const {
    ...
    if ( !clipAxisSlab(
            coordinates[MIN_X], coordinates[MAX_X],
    ...
    if ( !clipAxisSlab(
            coordinates[MIN_Y], coordinates[MAX_Y],
    ...
    if ( !clipAxisSlab(
            coordinates[MIN_Z], coordinates[MAX_Z],
...
inline bool
AxisAlignedBoundingBox::intersect(const Ray *ray, float minimumDistance, float *maximumDistance) const {

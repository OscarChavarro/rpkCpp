...
#include "vsdk/toolkit/raycasting/photonMap/DiscreteSampling.h"
...
void
SampleGrid2D::add(double x, double y, double value) {
...
void SampleGrid2D::EnsureNonZeroEntries() {
    int index;
...
void
SampleGrid2D::sample(double *x, double *y, double *probabilityDensityFunction) const {
    int xIndex;
    int yIndex;
    double xPdf;
    double yPdf;

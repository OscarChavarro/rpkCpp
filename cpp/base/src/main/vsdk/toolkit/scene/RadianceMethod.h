...
#include "vsdk/toolkit/scene/RadianceMethodAlgorithm.h"
...
class RadianceMethod {
  public:
    ...
    virtual ColorRgbMutable getRadiance(Camera *camera, Patch *patch, double u, double v, Vector3D dir, const RendererConfiguration *renderOptions) const = 0;

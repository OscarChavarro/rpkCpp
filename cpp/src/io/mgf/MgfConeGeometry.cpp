...
*/
int
MgfConeGeometry::handleEntity(int argumentCount, const char **argumentValues, ParseRuntimeContext *context) {
    char p3[3][24];
    char p4[3][24];
    char n3[3][24];
    char n4[3][24];
    ...
    const char *p3Entity[5] = {
        context->entityNames[EntityTypeContext::MGF_POINT], p3[0], p3[1], p3[2]};
    const char *n3Entity[5] = {
        context->entityNames[EntityTypeContext::MGF_NORMAL], n3[0], n3[1], n3[2]};
    ...
    errorCode = MgfDefinitions::mgfHandle(EntityTypeContext::VERTEX, 3, v3Entity, context);
    ...
    errorCode = MgfDefinitions::mgfHandle(EntityTypeContext::MGF_NORMAL, 4, n3Entity, context);
    if ( errorCode != ParseErrorContext::MGF_OK ) {
        return errorCode;
    }
    if ( radius1 == 0.0 ) {
        ...
        errorCode = MgfDefinitions::mgfHandle(EntityTypeContext::MGF_NORMAL, 4, n4Entity, context);
        if ( errorCode != ParseErrorContext::MGF_OK ) {
            return errorCode;
        }

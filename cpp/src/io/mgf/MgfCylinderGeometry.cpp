...
*/
int
MgfCylinderGeometry::handleEntity(int argumentCount, const char **argumentValues, ParseRuntimeContext *context) {
    ...
    return MgfDefinitions::mgfHandle(EntityTypeContext::CONE, 5, newArgumentValues, context);
}

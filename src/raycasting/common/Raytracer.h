...
class Raytracer {
  public:
    ...
    void (*Raytrace)(VoxelGrid *sceneWorldVoxelGrid, Background *sceneBackground, ImageOutputHandle *ip, java::ArrayList<Patch *> *scenePatches, java::ArrayList<Patch *> *lightPatches, Geometry *clusteredWorldGeometry, RadianceMethod *context);

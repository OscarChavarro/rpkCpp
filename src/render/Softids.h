...
extern SglContext *setupSoftFrameBuffer(const Camera *camera);
extern void softRenderPatches(const Scene *scene, const RenderOptions *renderOptions, SglContext *sglContext);

...
*/
static int
hierarchicRefinementCreateSubdivisionLink(GeometryListNode *candidatesList, GalerkinElement *rcv, GalerkinElement *src, INTERACTION *link) {
    ...
    bool isSceneGeometry = (candidatesList == GLOBAL_scene_world);

...
/**
Shaft is the region bounded by extent and ref1 and ref2 (if defined)
...
class Shaft {
  private:
    ...
    static bool verifyPolygonWrtPlane(POLYGON *poly, Vector3D *normal, double d, int side);
    ...
    void constructPolygonToPolygonPlanes(POLYGON *polygon1, POLYGON *polygon2);
    bool uniqueShaftPlane(ShaftPlane *parameterPlane);

...
class RadianceMethod {
  public:
    ...
    virtual void initialize(java::ArrayList<Patch *> *scenePatches, Geometry *clusteredWorldGeometry) = 0;
    ...
    virtual void renderScene(java::ArrayList<Patch *> *scenePatches, Geometry *clusteredWorldGeometry) = 0;

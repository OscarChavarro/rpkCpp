...
class SpecularSampler: public SurfaceSampler{ public:
    ...
    virtual double
    evalPDF( Camera *camera, SimpleRaytracingPathNode *thisNode, SimpleRaytracingPathNode *newNode, char flags, double *probabilityDensityFunction = NULL, double *probabilityDensityFunctionRR = NULL);
    ...
    // Return value should be multiplied by infinity!
    double
    EvalPDFPrev( SimpleRaytracingPathNode *prevNode, SimpleRaytracingPathNode *thisNode, SimpleRaytracingPathNode *newNode, char flags, double *probabilityDensityFunction, double *probabilityDensityFunctionRR);
};

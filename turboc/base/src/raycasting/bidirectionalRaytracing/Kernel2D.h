...
class Kernel2D{ private:
  ...
  public:
    ...
    void
    varCover( const Vector2D &center, const ColorRgb &color, const ScreenBuffer *ref, ScreenBuffer *dest, int totalSamples, int scaleSamples, float baseSize = 4.0);
};

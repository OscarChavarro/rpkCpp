...
class RadianceMethod {
  public:
    ...
    virtual void terminate(ArrayList<Patch *> *scenePatches) = 0;
    ...
    virtual ColorRgbMutable getRadiance(Camera *camera, Patch *patch, double u, double v, Vector3D dir, const RenderOptions *renderOptions) const = 0;

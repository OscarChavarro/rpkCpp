...
class VoxelGrid {
  private:
    ...
    #define DELTA_BOUND_FACTOR ((float)1e-4)

    static ArrayList<VoxelGrid *> *subGridsToDelete;
    static ArrayList<VoxelData *> *voxelCellsToDelete;

    short xSize;
    short ySize;
    short zSize;
    Vector3D voxelSize;
    ArrayList<VoxelData *> **volumeListsOfItems; // 3D array of item lists
    void **gridItemPool;

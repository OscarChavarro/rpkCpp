...
const double ColorContext::C1 = 3.741832e-16;
const double ColorContext::C2 = 1.4388e-2;
...
const ColorContext ColorContext::DEFAULT_COLOR_CONTEXT = {
    ...
    {
        ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL,
        ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL,
        ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL,
        ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL,
        ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL,
        ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL, ColorContext::CLR_NOM_MAX_SMP_VAL,
    ...
    ((long)(ColorContext::NUMBER_OF_SPECTRAL_SAMPLES)) * ColorContext::CLR_NOM_MAX_SMP_VAL,
    1.0 / 3.0,
    1.0 / 3.0,
    178.006f
};
...
ColorContext ColorContext::cie_xp = {
    1, CLR_DFND_WITH_SPCTR_FLAG | COLOR_SPECTRUM_IS_SET_FLAG | COLOR_XY_IS_SET_FLAG,
...
ColorContext ColorContext::cie_xf = {
    1, CLR_DFND_WITH_SPCTR_FLAG | COLOR_SPECTRUM_IS_SET_FLAG | COLOR_XY_IS_SET_FLAG | COLOR_EFFICACY_FLAG,
...
ColorContext::setSpectrum(double wlMinimum, double wlMaximum, int ac, const char **av) {
    ...
    scale = ColorContext::CLR_NOM_MAX_SMP_VAL / scale;
    ...
    flags = CLR_DFND_WITH_SPCTR_FLAG | COLOR_SPECTRUM_IS_SET_FLAG;
    clock++;
    return MGF_OK;
}
...
ColorContext::setBlackBodyTemperature(double tk) {
    ...
    sf = ColorContext::CLR_NOM_MAX_SMP_VAL / bBsp(wl, tk);
    ...
    ColorContext *c2)
{
    ...
    if ( (c1->flags | c2->flags) & CLR_DFND_WITH_SPCTR_FLAG ) {
        int i;
        // Spectral mixing

...
class Adaptation{ public:
  ...
  private:
    typedef ColorRgb (*PatchRadianceEstimateFn)(Patch *);
    ...
    static void estimateSceneAdaptation( PatchRadianceEstimateFn patchRadiance, const ArrayList<Patch *> *scenePatches, ToneMappingContext &toneMapOptions);
};

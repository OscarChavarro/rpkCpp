...
bool
PhongBidirTransDistFunc::isSpecular() const {
    return Ns >= PHONG_LOWEST_SPECULAR_EXP;
}

PhongBidirTransDistFunc::PhongBidirTransDistFunc(
...
*/
ColorRgb
PhongBidirTransDistFunc::evaluate(
...
Vector3D
PhongBidirTransDistFunc::sample(
    RefractionIndex inIndex,
    RefractionIndex outIndex,
    const Vector3D *in,
    const Vector3D *normal,
...
void
PhongBidirTransDistFunc::evalProbDensFunc(
    RefractionIndex inIndex,
    RefractionIndex outIndex,
    const Vector3D *in,
    const Vector3D *out,
...
*/
void
PhongBidirTransDistFunc::setIndexOfRefraction(RefractionIndex *index) const {

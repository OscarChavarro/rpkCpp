...
double Basistrimcrad::tm6(double u, double v) {
...
double Basistrimcrad::tm7(double u, double v) {
...
double Basistrimcrad::tm8(double u, double v) {
...
double Basistrimcrad::tm9(double u, double v) {
...
Basistrimcrad::BasisFunction Basistrimcrad::f[GALERKIN_MAX_BASIS_SIZE] =
...
Basistrimcrad::createBasis() {
    return Basistrimcrad::stchsRadCreateTriBasis();
}

GalerkinBasis
Basistrimcrad::stchsRadCreateTriBasis() {
    GalerkinBasis basis = GalerkinBasis();
    basis.description = "orthonormal basis on the standard triangle";
    basis.size = GALERKIN_MAX_BASIS_SIZE;
    basis.function = Basistrimcrad::f;
    basis.dualFunction = Basistrimcrad::f;
    basis.regularFilter = &Basistrimcrad::h;
    return basis;
}

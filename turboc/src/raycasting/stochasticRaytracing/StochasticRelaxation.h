...
class StochasticRelaxation {
  public:
    ...
    ColorRgb unShotFlux;
    ColorRgb totalFlux;
    ColorRgb indrcImpWghtdUnShotFlux;
    float unShotYmp;
    ...
    StochRaytrApprx approximationOrderType; // Radiosity approximation order
    ...
    long lastClock; // For computation timings (nanoseconds)

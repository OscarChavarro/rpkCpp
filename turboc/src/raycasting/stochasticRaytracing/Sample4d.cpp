...
Sampler4DSequence Sample4d::seq = RANDOM;
const char *Sample4d::RANDOM_NAME = "drand48";
const char *Sample4d::HALTON_NAME = "Halton";
const char *Sample4d::SCRAMBLED_HALTON_NAME = "ScramHalton";
const char *Sample4d::SOBOL_NAME = "sobol";
const char *Sample4d::ORIGINAL_FAURE_NAME = "faure";
const char *Sample4d::GENERALIZED_FAURE_NAME = "GFaure";
const char *Sample4d::NIEDERREITER_NAME = "Nied";
const char *Sample4d::UNKNOWN_NAME = "Unknown";
...
Sample4d::foldSampleF(double *xi1, double *xi2) {
    unsigned zeta1 = ((unsigned)(*xi1 * Niederreiter31::RECIP1));
    unsigned zeta2 = ((unsigned)(*xi2 * Niederreiter31::RECIP1));

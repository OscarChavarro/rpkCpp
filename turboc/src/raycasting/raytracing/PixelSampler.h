...
class PixelSampler: public Sampler{ private:
    double m_px;
    double m_py;
  public:
    ...
    double
    evalPDF( Camera *camera, SimpleRaytracingPathNode *thisNode, SimpleRaytracingPathNode *newNode, char flags = BsdfComponentInfo::BSDF_ALL_COMPONENTS, double *pdf = NULL, double *pdfRR = NULL);

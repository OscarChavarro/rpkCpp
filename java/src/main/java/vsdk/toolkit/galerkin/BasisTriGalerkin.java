...
public final class BasisTriGalerkin {
    ...
    public static GalerkinBasis instance() {
        ...
        GalerkinBasis triBasis = new GalerkinBasis();
    ...
    private static double tg6(double u, double v) {
    ...
    private static double tg7(double u, double v) {
    ...
    private static double tg8(double u, double v) {
    ...
    private static double tg9(double u, double v) {

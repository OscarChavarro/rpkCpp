...
public class Niederreiter {
    public static final int DIMEN = Niederreiter63.DIMEN;
    public static final int NBITS = Niederreiter63.NBITS;
    public static final long SKIP = Niederreiter63.SKIP;
    public static final long NBITS_POW = Niederreiter63.NBITS_POW;
    public static final long NBITS_POW1 = Niederreiter63.NBITS_POW1;
    public static final double RECIP = Niederreiter63.RECIP;
    public static final double RECIP1 = Niederreiter63.RECIP1;
    ...
    */
    ...
    k * Do not modify the returned ints
    */
    public static long[] Nied(long n) {
    ...
    Upon exit, *idx will contain the index of the sample that is returned
    */
    public static long[] NextNiedInRange(
        long[] idx,
        int dir,
        int nmsb,
        long msb1,
    ...
    Computes the (NBITS-bits) base-2 radical inverse of the given number
    */
    public static long radicalInverse(long n) {
    ...
    "folds" a sample in the unit square to the standard triangle (0, 0), (1, 0), (0, 1)
    */
    public static void foldSample(long[] xi1, long[] xi2) {
        Niederreiter63.foldSample63(xi1, xi2);
    }

    private Niederreiter() {
    }
}
